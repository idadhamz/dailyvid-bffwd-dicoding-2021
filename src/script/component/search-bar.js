  ...
  render() {
    this.innerHTML = `
        <div class="flex flex-col sm:flex-row gap-4 my-10">
            <input id="searchElement" type="search" placeholder="Cari Berdasarkan Nama Negara, Contoh: Indonesia" class="w-full h-auto border border-gray-400 rounded-xl p-4 text-md sm:w-1/3" required>
